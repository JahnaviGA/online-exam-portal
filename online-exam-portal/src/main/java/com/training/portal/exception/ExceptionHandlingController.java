...
public class ExceptionHandlingController {
	...
	@ResponseBody
	public ErrorResponse resourceNotFound(BusinessException ex) {
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ResponseBody
	public ErrorResponse internalException(BusinessException ex) {
		ErrorResponse response = new ErrorResponse();
		response.setStatus(Integer.parseInt(ex.getResponseDetail().getCode()));
		response.setMessage(ex.getResponseDetail().getMessage());
		response.setUiErrorKey(ex.getResponseDetail().getUiErrorKey());
...
//	}
	...
	@ResponseBody
	public ErrorResponse emptyDataAccessException(EmptyResultDataAccessException ex) {
		ErrorResponse response = new ErrorResponse();
		response.setStatus(404);
